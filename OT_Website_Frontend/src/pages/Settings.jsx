...
function Settings() {
    ...
    const updateUserLinkedIn = async (e) => {
        ...
        try {
            const response = await fetch(`https://ec2-18-117-157-65.us-east-2.compute.amazonaws.com:443/users/linkedIn/${authData.email}`, {
                method: 'PUT',
                headers: {
    ...
    const updateUserImage = async (e) => {
        ...
        try {
            const response = await fetch(`https://ec2-18-117-157-65.us-east-2.compute.amazonaws.com:443/users/image/${authData.email}`, {
                method: 'PUT',
                body: formData
            });
    ...
    useEffect(() => {
        const checkAdminStatus = async () => {
            try {
                const response = await fetch(`https://ec2-18-117-157-65.us-east-2.compute.amazonaws.com:443/users/checkAdminStatus/${authData._id}`, {
