...
function AdminList() {
    ...
    useEffect(() => {
        ...
        const fetchNonAdminUsers = async () => {
            try {
                const response = await fetch('https://ec2-18-117-157-65.us-east-2.compute.amazonaws.com:80/users/nonAdminUsers/'); // Adjust the URL as needed
                if (response.ok) {
    ...
    const handleAdminPromotion = async (userId) => {
        ...
        try {
            const response = await fetch(`https://ec2-18-117-157-65.us-east-2.compute.amazonaws.com:80/users/promoteToAdmin/${userId}`, {
                method: 'PUT',
                headers: {
